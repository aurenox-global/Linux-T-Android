#!/usr/bin/env python3
"""Reescribe rutas/nombres en binarios de Termux para la app Linux-TC (io.debi.tc).
...
NOTA: `/data/data/com.termux/files/usr` (31) -> `/data/data/io.debi.tc/files/usr`
...
PAIRS = [
    ...
    (b"/data/data/com.termux/files/usr", b"/data/data/io.debi.tc/files/usr"),
