...
// Al terminar el build, renombra el APK a Linux-TNubePro-<versionName>-<buildType>.apk
tasks.matching { it.name == "assembleDebug" || it.name == "assembleRelease" }.configureEach {
    doLast {
        ...
        if (src != null) {
            val dst = File(dir, "Linux-TNubePro-${android.defaultConfig.versionName}-$bt.apk")
