...
para la app **Linux-TNube Pro**: mipmaps legacy, foreground adaptativo y roundIcon.
...
# Ruta del proyecto relativa a este script (funciona en Linux-T y en Linux-TNube Pro)
