...
class MainActivity : Activity() {
    ...
    inner class Bridge {
            ...
            try {
                runOnUiThread {
                    try {
                        ...
                        cm.setPrimaryClip(android.content.ClipData.newPlainText("Linux-TPro", text))
                    } catch (_: Throwable) { }
                }
            } catch (_: Throwable) { }
        }
        ...
        /**
         * Comprueba el runtime de OpenClaw. En Linux-TPro TODO viene empaquetado en el
        ...
        fun ocInstall() {
            Thread {
                val script = buildString {
                    append("echo '== Linux-TPro · OpenClaw =='; ")
                    ...
                    append("else ")
                    append("echo 'openclaw: NO encontrado. Reinstala Linux-TPro para restaurar el runtime empaquetado.'; ")
