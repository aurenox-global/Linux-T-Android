#!/usr/bin/env python3
"""Reescribe rutas/nombres en binarios de Termux para la app Linux-TPro (io.debipro).
...
NOTA: `/data/data/com.termux/files/usr` (31) -> `/data/data/io.debipro/files/usr`
(31): encajan EXACTAMENTE (antes era io.debi, con 3 NUL de relleno; ahora .tc
ocupa ese relleno). Si cambias el applicationId, ajusta aquí y re-parchea el
binario proot (las otras dos libs y los loader NO llevan rutas de paquete).
"""
import sys

PAIRS = [
    # (viejo, nuevo) — el nuevo debe ser <= en longitud
    (b"/data/data/com.termux/files/usr", b"/data/data/io.debipro/files/usr"),
